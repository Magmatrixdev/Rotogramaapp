...
// ═══ FIREBASE CONFIG ═══
const APP_VERSION = 45; // Incrementar a cada deploy para forçar update em todos os devices
...
// Chave pública VAPID (Web Push) — pública por natureza, fica no cliente por design
const VAPID_KEY='BIEXRrqYu-hvbLWY3SxxT-CTySY-NN1ZLIjLbxpQdHoKXetRMgRyLpMjFVgSUVItQJVYqvXHBcdX69u4h1Myjs8';
